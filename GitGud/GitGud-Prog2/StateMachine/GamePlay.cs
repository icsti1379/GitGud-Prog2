...
namespace GitGudP2
{
    ...
    public class GamePlay : State
    {
        ...
        public GamePlay()
        {
            ...
            //COMMIT: commit = Changed kip to npcAiChicken
            npcAiChicken = new Chicken();

            npcAiChicken.Waypoints = new List<Waypoint>();
            npcAiChicken.Waypoints.Add(new Waypoint(0, 0));
            npcAiChicken.Waypoints.Add(new Waypoint(50, 0));
            npcAiChicken.Waypoints.Add(new Waypoint(50, 50));
            npcAiChicken.Waypoints.Add(new Waypoint(0, 50));
